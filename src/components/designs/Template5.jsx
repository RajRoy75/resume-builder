...
const Template5 = () => {
  ...
  const handleFileSelect = async (event) => {
    ...
    setImageAsset((prev) => ({ ...prev, isImageLoading: true, imageUrl: null }));
  ...
  const saveFormData = async () => {
    ...
    const profilePicToSave = imageAsset.imageUrl && imageAsset.imageUrl.startsWith('data:image/') ? imageAsset.imageUrl : null;
      ...
      <div className="w-full lg:w-[1200px] flex flex-col items-center justify-start px-4 md:px-8 lg:px-16">
        ...
        <div className="w-full max-w-4xl min-h-[1123px] bg-white shadow-lg overflow-hidden" ref={resumeRef}>
          <div className="grid grid-cols-12 min-h-[1123px]"> {/* Ensure grid takes full height */}
            ...
            {/* Right Column (White) */}
            <div className="col-span-12 md:col-span-8 bg-white p-8 pl-12 relative">
              {/* Vertical Yellow Line */}
              <div className="absolute left-6 top-8 bottom-8 w-1 bg-yellow-500"></div>
