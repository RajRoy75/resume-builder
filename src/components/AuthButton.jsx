...
function AuthButton({Icon,label,provider}) {
  return (
    <div className='w-full px-4 py-3 rounded-md border-2 border-blue-700 flex items-center justify-between cursor-pointer group hover:bg-blue-700 active:scale-95 hover:shadow-md duration-150'>
